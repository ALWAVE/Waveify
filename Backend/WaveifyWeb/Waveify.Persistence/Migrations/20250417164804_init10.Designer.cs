...
namespace Waveify.Persistence.Migrations
{
    ...
    [Migration("20250417164804_init10")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SongEntityTagEntity", b =>
                {
            ...
            modelBuilder.Entity("Waveify.Persistence.Entities.SongEntity", b =>
                {
                    ...
                    b.HasDiscriminator<string>("Discriminator").HasValue("SongEntity");
            ...
            modelBuilder.Entity("Waveify.Persistence.Entities.BeatEntity", b =>
                {
                    b.HasBaseType("Waveify.Persistence.Entities.SongEntity");
                    ...
                    b.Property<string>("TypeBeat")
                        .IsRequired()
                        .HasColumnType("text");

                    b.HasDiscriminator().HasValue("BeatEntity");
                });

            modelBuilder.Entity("Waveify.Persistence.Entities.TrackEntity", b =>
                {
                    b.HasBaseType("Waveify.Persistence.Entities.SongEntity");

                    b.Property<int>("CountAuditions")
                        .HasColumnType("integer");

                    b.Property<int>("MusicBoost")
                        .HasColumnType("integer");

                    b.HasDiscriminator().HasValue("TrackEntity");
                });
