...
const TitleBar = () => {
  ...
  return (
    <div
      className="no-drag absolute top-0 mt-4 right-0 flex select-none "
    ...
    >
      ...
      <button id="maximize-btn" className="rounded-b-lg rounded-t-lg px-3 py-2 text-[var(--text)] hover:bg-gradient-to-r from-blue-600 to-violet-900" onClick={handleMaximize}>
        <IoIosSquareOutline size={17} />
      </button>
      <button id="close-btn" className="rounded-l-lg px-3 py-2 text-xl text-[var(--text)] bg-transparent hover:bg-gradient-to-r from-red-600 to-red-900 transition" onClick={handleClose}>
        <CgClose size={17} />
      </button>
