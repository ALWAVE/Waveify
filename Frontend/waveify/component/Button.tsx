    ...
    if (iconName) {
      ...
      return iconNames.map((name, index) => {
        return (
          <span
            key={name}
            className={`material-icons-round icon relative flex items-center justify-center text-lg !leading-none ${label && iconNames.length - 1 === index && 'mr-3'
