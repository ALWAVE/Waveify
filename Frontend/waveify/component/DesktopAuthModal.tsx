...
const DesktopAuthModal = ({ isOpen, initialMode = "login" }) => {
  ...
  return (
    <Modal
      ...
      isOpen={isOpen}
      onChange={() => {} /* Отключаем закрытие окна */}
    ...
    >
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <button
          type="submit"
          className="cursor-pointer w-full bg-gradient-to-r from-violet-500 to-pink-500 text-white py-2 rounded-md hover:scale-105 transition-transform disabled:opacity-50"
          disabled={loading}
        >
